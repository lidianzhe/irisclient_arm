...
//
// Versioon 2.2.6   Feb. 17, 2015
//  - fixed buffer overflow bug in the BMTDemo when images are captured
//  - fixed buffer overrun bug. anymore don't use terminate but use abort & wait.
//
...
#define CMIRISLIB_MINOR_VERSION         2
#define CMIRISLIB_REVISION              6

...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sat Oct 25 01:29:31 2014
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_WEBKIT -D_EMALIB -DDEMOTOOLBOX -D_EXYNOS_ARM -D_LIBUDEV -D_LIBUSB -D_OPENCV -DQT_SQL_LIB -DQT_GUI_LIB -DQT_CORE_LIB -DQT_SHARED

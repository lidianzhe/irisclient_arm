...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mon Jul 6 20:07:07 2015
# Project:  IrisClient.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -spec ../../../../share/qt4/mkspecs/linux-g++ -o Makefile IrisClient.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_WEBKIT -D_EMALIB -DDEMOTOOLBOX -D_SENDTOSERVER -D_ABDOOR -D_EXYNOS_ARM -D_LIBUDEV -D_LIBUSB -D_OPENCV -DQT_NO_DEBUG_OUTPUT -DQT_NO_WARNING_OUTPUT -DQT_NO_DEBUG -DQT_SQL_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
Makefile: IrisClient.pro  ../../../../share/qt4/mkspecs/linux-g++/qmake.conf ../../../../share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec ../../../../share/qt4/mkspecs/linux-g++ -o Makefile IrisClient.pro
...
moc_udpserverthread.cpp: azirisinfo.h \
		udpserverthread.h
...
install_irisclient: first FORCE
	...
	-strip $(INSTALL_ROOT)/usr/local/bin/IrisClient

...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sun Nov 30 11:26:46 2014
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/IrisClient1.0.0/ && $(COPY_FILE) --parents mainwindow.h cdatabase.h dialogname.h eventthread.h dmeventthread.h dbrecord.h inoutinfo.h inoutcontroller.h emaeventthread.h .tmp/IrisClient1.0.0/ && $(COPY_FILE) --parents mainwindow.cpp main.cpp cdatabase.cpp dialogname.cpp eventthread.cpp dmeventthread.cpp dbrecord.cpp inoutinfo.cpp inoutcontroller.cpp emaeventthread.cpp .tmp/IrisClient1.0.0/ && $(COPY_FILE) --parents mainwindow.ui dialogname.ui .tmp/IrisClient1.0.0/ && (cd `dirname .tmp/IrisClient1.0.0` && $(TAR) IrisClient1.0.0.tar IrisClient1.0.0 && $(COMPRESS) IrisClient1.0.0.tar) && $(MOVE) `dirname .tmp/IrisClient1.0.0`/IrisClient1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/IrisClient1.0.0

...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Dec 3 00:41:23 2014
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_WEBKIT -D_EMALIB -D_SENDTOSERVER -D_EXYNOS_ARM -D_LIBUDEV -D_LIBUSB -D_OPENCV -DQT_NO_DEBUG_OUTPUT -DQT_NO_WARNING_OUTPUT -DQT_NO_DEBUG -DQT_SQL_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
